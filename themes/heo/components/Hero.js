  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          'rounded-xl overflow-hidden opacity-0 group-hover:opacity-100 duration-300 transition-all bg-[#272727dd] dark:bg-[#dca846] dark:text-white cursor-pointer absolute w-full h-full top-0 flex justify-start items-center'
        }
      >
  ...
  return (
    ...
    >
      <div
        ...
        } shadow transition-all duration-200 today-card h-full bg-[#272727] rounded-xl relative overflow-hidden flex items-end`}
      >
        <div
          id="today-card-info"
